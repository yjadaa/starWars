...
public class MyGUI1 : MonoBehaviour {
	...
	void Start () {
        ...
        hitsRemainingPos = new Rect( 30, 610, 300, 30 );
    ...
    void OnGUI()
    {
        GUI.Label( laserDeflectedPos, "Health: " +  (int)playerState.healthRemaining + "%");
		GUI.Label( hitsRemainingPos, "Gesture: " +  playerState.EnumToString(playerState.currentGesture));
    }
}
